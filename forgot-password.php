...
$conn = mysqli_connect('localhost', 'root', 'root', 'gestion_aide');
if (!$conn) {
...
function save_password($password){
	...
	$query = "UPDATE snmm_users SET password ='$password' WHERE email = '$email' LIMIT 1";
...
function valid_email($email){
	...
	$query = "SELECT * FROM snmm_users WHERE email = '$email' LIMIT 1";
	$result = mysqli_query($conn, $query);
	if ($result) {
		if (mysqli_num_rows($result) > 0) 
		{
        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                ...
                <form action="forgot-password.php" method="POST" autocomplete="">
                    <h2 class="text-center">Password Oublié</h2>
					<br/>
        
                    <div class="form-group">
                        <input class="form-control" type="email" name="email" placeholder="Entrez adresse email">
                    </div>
                ...
                <div class="register-box">
					<h1 style="text-decoration: underline;" class="text-center">Vérification du code</h1>
					<p class="text-center">Entrez le code qui a été envoyé à votre adresse e-mail <br/> <strong>Le code expire dans 10 minutes!</strong><p>
                ...
                <form action="forgot-password.php?mode=enter_code" method="POST">
                    ...
                    <input style="width: 50%; margin-left:25%" type="text" class="form-control" name="code" placeholder="Entrer le code"> <br>		

                    <button style="width: 30%; margin-left:35%; color: white; background-color: blue;" type="submit" class="form-control button" name="SavePassChanges">Suivant</button>

                    <a href="forgot-password.php" class="login save">
                        <p style="width: 50%; margin-left:35% ;" ,>Redémarrer Réinitialisation</p>
                    </a>
                </form>
